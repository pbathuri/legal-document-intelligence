...
def test_india_graph_runs():
    ...
    store.upsert_document_chunks(
        ...
        chunks=[
            (
                "This sale deed executed by seller Ramesh Kumar in favour of buyer Suresh Rao for plot survey number 123/A in Kukatpally village.",
                {"page_start": 1, "page_end": 1},
            ),
            (
                "Consideration amount Rs 50,00,000. Encumbrance Certificate shows no prior charge.",
